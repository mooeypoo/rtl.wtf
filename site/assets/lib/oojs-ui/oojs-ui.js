...
OO.ui.PopupWidget.prototype.bindMouseDownListener = function () {
	...
	// Mobile browsers, especially Safari iOS, do not recognize 'mousedown' and must listen to 'touchstart'
	OO.ui.addCaptureEventListener( this.getElementWindow(), 'touchstart', this.onMouseDownHandler );
};
...
OO.ui.PopupWidget.prototype.unbindMouseDownListener = function () {
	...
	// Mobile browsers, especially Safari iOS, do not recognize 'mousedown' and must listen to 'touchstart'
	OO.ui.removeCaptureEventListener( this.getElementWindow(), 'touchstart', this.onMouseDownHandler );
};
